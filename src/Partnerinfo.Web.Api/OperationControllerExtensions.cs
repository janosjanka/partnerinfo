...
namespace Partnerinfo
{
    ...
    public static class OperationControllerExtensions
    {
        ...
        /// </returns>
        public static OperationActionResult OperationResult(this Controller controller, OperationResult result) => new OperationActionResult(result, null);
        ...
        /// The <see cref="OperationActionResult" /> result that renders a view to the response.
        /// </returns>
        public static OperationActionResult OperationResult(this Controller controller, OperationResult result, object value) => new OperationActionResult(result, value);
    }
}