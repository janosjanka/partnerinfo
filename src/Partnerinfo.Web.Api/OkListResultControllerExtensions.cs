...
namespace Partnerinfo
{
    ...
    public static class OkListResultControllerExtensions
    {
        ...
        /// </returns>
        public static OkListResult OkList(this Controller controller, IEnumerable<object> data, int offset, int limit)
        {
            return new OkListResult(controller.Url, data, offset, limit);
        }
    }
}